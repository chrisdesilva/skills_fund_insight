...
export const leadContent = {
  ...
  paragraph: `${schoolName} designs its programs to provide students a foundation for a career in data science. ${schoolName} partners with Skills Fund to offer tuition${
